...
import Handler.AppStats
import Handler.Monitoring
import Handler.Search
import Handler.Cache
import Handler.Import
import Handler.TextAdvise
import Handler.SimpleAdvices
import Handler.SimpleAdvice
import Handler.Tech
import Handler.TechWithId
import Handler.About
import Handler.Guide
import Handler.Tax
import Handler.Terms
import Handler.Marks
import Handler.Models
import Handler.Edito
...
makeFoundation appSettings = do
    ...
    appLogger <- newFileLoggerSet defaultBufSize "application.log" >>= makeYesodLogger
    appStatic <-
